        ...
        <el-form :model="loginForm" label-width="0px" :rules="loginFormRule"
            ...
            <el-form-item prop="code">
                <el-input size="normal" type="text" v-model="loginForm.code" auto-complete="off"
                          placeholder="点击图片更换验证码" @keydown.enter.native="submitLogin" style="width: 250px" prefix-icon="el-icon-lock"></el-input>
                <el-image :src="codeUrl" @click="refreshCode" alt="" style="cursor: pointer;height: 25px"/>
            </el-form-item>
            <!-- 记住我 -->
